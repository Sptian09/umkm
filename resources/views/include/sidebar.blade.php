    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="dashboard"><img src="{{ asset('template/assets/images/logo/shop.svg') }}" alt="Logo"
                            srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item">
                    <a href="{{ route('makanan.index') }}" class='sidebar-link'>
                ...
                <li class="sidebar-item">
                    <a href="{{ route('minuman.minuman') }}" class='sidebar-link'>
                        <i class="bi bi-collection-fill"></i>
                        <span>Minuman</span>
                    </a>
                    {{-- <ul class="submenu ">
